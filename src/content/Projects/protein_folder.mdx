...
<img 
  src="https://github.com/albertbayazidi/basic_protein_folding/blob/main/_misc/data/monte_carlo_sim/task_2.5/gif/main_sim.gif?raw=true" 
  alt="Gif of protein folding"
  class="w-7/8 max-w-3xl mx-auto rounded-xl shadow-xl my-8 " 
/>
